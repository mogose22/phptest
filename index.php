...
define('APP_ID', 'local.5ed6a59f2e5659.48821595'); // take it from Bitrix24 after adding a new application
define('APP_SECRET_CODE', 'ntrP6enk1CShLPho4dLbvlOUKr6chzdsLtenertoJ1ITzQzXFK'); // take it from Bitrix24 after adding a new application
define('APP_REG_URL', 'https://mogose22.testphpapp.github.io'); // the same URL you should set when adding a new application in Bitrix24
